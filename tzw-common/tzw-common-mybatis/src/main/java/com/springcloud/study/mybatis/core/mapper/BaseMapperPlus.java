package com.springcloud.study.mybatis.core.mapper;
...
/**
 * 类 描 述: 自定义 Mapper 接口, 实现 自定义扩展
 * 作   者: 谭志伟
 * 时   间: 2022/9/21  14:01
 */
public interface BaseMapperPlus<M, T, V> extends BaseMapper<T>, MPJBaseMapper<T> {
